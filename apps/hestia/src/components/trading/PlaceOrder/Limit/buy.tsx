      ...
      */}
      ...
      <Range
        ranges={[
          {
            value: "25%",
            action: () => onChangeRange(25, spendable),
          },
          {
            value: "50%",
            action: () => onChangeRange(50, spendable),
          },
          {
            value: "75%",
            action: () => onChangeRange(75, spendable),
          },
          {
            value: "100%",
            action: () => onChangeRange(100, spendable),
          },
        ]}
      />
      <div
      ...
      <OrderAction>
        {isSignedIn ? (
          ...
          <ConnectAccount side="buy" ticker={market?.baseAsset?.ticker} />
        )}
      </OrderAction>
    </form>
  );
