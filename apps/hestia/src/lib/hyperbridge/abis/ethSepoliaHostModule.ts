export const ABI = [
  {
    inputs: [
      {
        components: [
          { internalType: "uint256", name: "defaultTimeout", type: "uint256" },
          {
          ...
          { internalType: "address", name: "hostManager", type: "address" },
          { internalType: "address", name: "uniswapV2", type: "address" },
          { internalType: "uint256", name: "unStakingPeriod", type: "uint256" },
          { internalType: "uint256", name: "challengePeriod", type: "uint256" },
          { internalType: "address", name: "consensusClient", type: "address" },
          {
            internalType: "uint256[]",
            name: "stateMachines",
            type: "uint256[]",
          ...
          {
            components: [
              { internalType: "bytes32", name: "stateIdHash", type: "bytes32" },
              { internalType: "uint256", name: "perByteFee", type: "uint256" },
            ],
  ...
  { inputs: [], name: "CannotChangeFeeToken", type: "error" },
  { inputs: [], name: "DuplicateResponse", type: "error" },
  { inputs: [], name: "FrozenHost", type: "error" },
  { inputs: [], name: "InvalidAddressLength", type: "error" },
  { inputs: [], name: "InvalidConsensusClient", type: "error" },
  { inputs: [], name: "InvalidHandler", type: "error" },
  { inputs: [], name: "InvalidHostManager", type: "error" },
  { inputs: [], name: "InvalidHyperbridgeId", type: "error" },
  { inputs: [], name: "InvalidStateMachinesLength", type: "error" },
  { inputs: [], name: "InvalidUnstakingPeriod", type: "error" },
  { inputs: [], name: "UnauthorizedAccount", type: "error" },
  { inputs: [], name: "UnauthorizedAction", type: "error" },
  { inputs: [], name: "UnauthorizedResponse", type: "error" },
  { inputs: [], name: "UnknownRequest", type: "error" },
  { inputs: [], name: "UnknownResponse", type: "error" },
  ...
  },
  {
    ...
    inputs: [
      ...
      { indexed: false, internalType: "bool", name: "native", type: "bool" },
    ],
    name: "HostWithdrawal",
    type: "event",
  },
  {
    ...
    inputs: [
      ...
      { indexed: false, internalType: "bytes", name: "body", type: "bytes" },
      { indexed: false, internalType: "uint256", name: "fee", type: "uint256" },
    ],
    ...
    inputs: [
      ...
      },
      {
        components: [
          ...
          { internalType: "bytes32", name: "overlayRoot", type: "bytes32" },
  ...
  },
  {
    inputs: [],
    name: "frozen",
    outputs: [{ internalType: "enum FrozenStatus", name: "", type: "uint8" }],
    stateMutability: "view",
    type: "function",
  },
  {
  ...
  {
    inputs: [{ internalType: "bytes", name: "stateId", type: "bytes" }],
    name: "perByteFee",
    outputs: [{ internalType: "uint256", name: "", type: "uint256" }],
    stateMutability: "view",
    type: "function",
  ...
  {
    inputs: [
      { internalType: "enum FrozenStatus", name: "newState", type: "uint8" },
    ],
    name: "setFrozenState",
    outputs: [],
    stateMutability: "nonpayable",
  ...
  {
    inputs: [
      { internalType: "bytes", name: "parachainId", type: "bytes" },
  ...
  {
    inputs: [
      { internalType: "uint256", name: "paraId", type: "uint256" },
      { internalType: "uint256", name: "height", type: "uint256" },
    ],
    name: "vetoes",
    outputs: [{ internalType: "address", name: "", type: "address" }],
